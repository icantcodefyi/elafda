...
export const mockELafdaData: ELafda = {
  ...
  description:
    "A comprehensive discussion about the future of React and Next.js frameworks, featuring insights from developers worldwide and the latest performance benchmarks.",
  author: {
    id: "author-1",
    username: "techguru42",
  ...
  tweets: [
    {
      ...
      authorId: "author-1",
      content:
        "Starting this heated debate about Next.js vs pure React. What are your thoughts? #NextJS #React",
      createdAt: "2024-01-15T10:30:00Z",
      order: 1,
    },
    {
      ...
      authorId: "author-2",
      content:
        "Hot take: Next.js is becoming too opinionated. Sometimes you just need React!",
    ...
    },
    {
      ...
      authorId: "author-3",
      content:
        "Performance benchmarks show Next.js 14 with app router is incredible for SEO and load times",
...
export const mockELafdaComments: ELafdaComment[] = [
  {
    id: "comment-1",
    content:
      "Great discussion! I've been using Next.js for 2 years and the developer experience is unmatched.",
    author: {
      id: "user-1",
      username: "devexpert",
  ...
  },
  {
    id: "comment-2",
    content:
      "While Next.js is great, sometimes you need the flexibility of a custom React setup. It depends on the project requirements.",
    author: {
      id: "user-3",
      username: "reactninja",
  ...
  },
  {
    id: "comment-3",
    content:
      "The new app directory in Next.js 13+ changed everything. Server components are the future!",
    author: {
      id: "user-4",
...
export const relatedELafdas: Omit<
  ELafda,
  "tweets" | "polls" | "attachments"
>[] = [
  {
    id: "2",
    title: "TypeScript vs JavaScript in 2024",
    description:
      "The ongoing debate about whether TypeScript is worth the complexity",
    author: {
      id: "author-2",
  ...
  },
  {
    ...
    description:
      "Tailwind CSS vs CSS-in-JS vs traditional CSS - what's winning?",
    author: {
      id: "author-3",
      username: "csswizard",
